	...
	private class CheckListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.clearplatinumvisa:
				iInfo = new ImageInfo(R.drawable.citibank_clear_platinum_visa_label, R.drawable.citibank_clear_platinum_visa);
			...
			case R.id.dividendplatinum:
				iInfo = new ImageInfo(R.drawable.citibank_dividend_platinum_mastercard_label, R.drawable.citibank_dividend_platinum_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.paragonmastercard:
				iInfo = new ImageInfo(R.drawable.citibank_paragon_mastercard_label, R.drawable.citibank_paragon_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.paragonvisa:
				iInfo = new ImageInfo(R.drawable.citibank_paragon_visa_label, R.drawable.citibank_paragon_visa);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.premieremilesvisa:
				iInfo = new ImageInfo(R.drawable.citibank_premiermiles_visa_signature_label, R.drawable.citibank_premiermiles_visa_signature);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
				...
				break;
			case R.id.smrtcard:
				iInfo = new ImageInfo(R.drawable.citibank_smrt_card_label, R.drawable.citibank_smrt_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.blackamericanexpress:
				iInfo = new ImageInfo(R.drawable.dbs_black_american_express_card_label, R.drawable.dbs_black_american_express_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.livefreshplatinum:
				iInfo = new ImageInfo(R.drawable.dbs_live_fresh_platinum_card_label, R.drawable.dbs_live_fresh_platinum_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.dbsplatinummastercard:
				iInfo = new ImageInfo(R.drawable.dbs_platinum_mastercard_label, R.drawable.dbs_platinum_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.artsplatinumcard:
				iInfo = new ImageInfo(R.drawable.ocbc_arts_platinum_card_label, R.drawable.ocbc_arts_platinum_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.bestdenkiplatinumcard:
				iInfo = new ImageInfo(R.drawable.ocbc_best_denki_platinum_card_label, R.drawable.ocbc_best_denki_platinum_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.classicvisacard:
				iInfo = new ImageInfo(R.drawable.ocbc_classic_visa_card_label, R.drawable.ocbc_classic_visa_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
				...
				break;
			case R.id.debitcard:
				iInfo = new ImageInfo(R.drawable.ocbc_debit_card_label, R.drawable.ocbc_debit_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.fairpriceplusvisacard:
				iInfo = new ImageInfo(R.drawable.ocbc_fairpriceplus_visa_card_label, R.drawable.ocbc_fairpriceplus_visa_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.goldmastercard:
				iInfo = new ImageInfo(R.drawable.ocbc_gold_mastercard_label, R.drawable.ocbc_gold_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.ikeafriendsvisacard:
				iInfo = new ImageInfo(R.drawable.ocbc_ikea_friends_visacard_label, R.drawable.ocbc_ikea_friends_visa_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.ntuvisaclassiccard:
				iInfo = new ImageInfo(R.drawable.ocbc_ntu_visa_classic_card_label, R.drawable.ocbc_ntu_visa_classic_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.ntuvisagoldcard:
				iInfo = new ImageInfo(R.drawable.ocbc_ntu_visa_gold_card_label, R.drawable.ocbc_ntu_visa_gold_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.platinummastercard:
				iInfo = new ImageInfo(R.drawable.ocbc_platinum_mastercard_label, R.drawable.ocbc_platinum_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.robinsonsplatinumcard:
				iInfo = new ImageInfo(R.drawable.ocbc_robinsons_platinum_card_label, R.drawable.ocbc_robinsons_platinum_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.smudebitcards:
				iInfo = new ImageInfo(R.drawable.ocbc_smu_debit_cards_label, R.drawable.ocbc_smu_debit_cards);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.smuplatinummastercard:
				iInfo = new ImageInfo(R.drawable.ocbc_smu_platinum_mastercard_label, R.drawable.ocbc_smu_platinum_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.titaniummastercard:
				iInfo = new ImageInfo(R.drawable.ocbc_titanium_mastercard_label, R.drawable.ocbc_titanium_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.uplusvisacard:
				iInfo = new ImageInfo(R.drawable.ocbc_uplus_visa_card_label, R.drawable.ocbc_uplus_visa_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.uplusplatinumcard:
				iInfo = new ImageInfo(R.drawable.ocbc_uplus_platinum_card_label, R.drawable.ocbc_uplus_platinum_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.yesdebitcard:
				iInfo = new ImageInfo(R.drawable.ocbc_yes_debit_card_label, R.drawable.ocbc_yes_debit_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.directvisacard:
				iInfo = new ImageInfo(R.drawable.uob_direct_visa_card_label, R.drawable.uob_direct_visa_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
				...
				break;
			case R.id.ladyscard:
				iInfo = new ImageInfo(R.drawable.uob_ladys_card_label, R.drawable.uob_ladys_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.mastercardclassiccard:
				iInfo = new ImageInfo(R.drawable.uob_mastercard_classic_card_label, R.drawable.uob_mastercard_classic_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.mastercardgoldcard:
				iInfo = new ImageInfo(R.drawable.uob_mastercard_gold_card_label, R.drawable.uob_mastercard_gold_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
				...
				break;
			case R.id.onecard:
				iInfo = new ImageInfo(R.drawable.uob_one_card_label, R.drawable.uob_one_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.preferredworld:
				iInfo = new ImageInfo(R.drawable.uob_preferred_world_mastercard_label, R.drawable.uob_preferred_world_mastercard);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.prvivisaamerican:
				iInfo = new ImageInfo(R.drawable.uob_prvi_visa_american_express_card_label, R.drawable.uob_prvi_visa_american_express_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.visaclassiccard:
				iInfo = new ImageInfo(R.drawable.uob_visa_classic_card_label, R.drawable.uob_visa_classic_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.visagoldcard:
				iInfo = new ImageInfo(R.drawable.uob_visa_gold_card_label, R.drawable.uob_visa_gold_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.visainfinitecard:
				iInfo = new ImageInfo(R.drawable.uob_visa_infinite_card_label, R.drawable.uob_visa_infinite_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
			...
			case R.id.visasignaturecard:
				iInfo = new ImageInfo(R.drawable.uob_visa_signature_card_label, R.drawable.uob_visa_signature_card);
				if(((CheckBox)v).isChecked()) {
					images.add(iInfo);
				}
				else {
